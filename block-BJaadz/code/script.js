...
allHrs = document.querySelectorAll("hr")
...
let box17 = document.querySelector(".seventeen").style.display = "none"
...
Array.from(one.children).forEach((ele) => ele.remove())
...
let arrayBox = Array.from(document.querySelectorAll(".box"))
arrayBox.filter
((ele,index) => {
  if(index % 2 == 0)
  return ele
})
.map((ele) => ele.style.background = "aliceblue")
...
imgElm.src = "https://images.unsplash.com/photo-1532993680872-98b088e2cacd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=80";

// Select the box 7 using class seven
let box7 = document.querySelector(".seven")

// Remove all the elements form box seven
Array.from(box7.children).forEach((ele) => ele.remove())
...
document.querySelector(".five").append(alt,google)
