...
document.body.children[6].children['email']

// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`
let topics = document.querySelector(".topics")
console.log(topics.children.length)
...
let attrPassword = document.getElementById("password").placeholder

// 10. Select all the `li` element and store in `allTopics`
let allTopics = document.querySelectorAll("li")

// 11. Select all the input element of any type and store in `allInput`
let allInut = document.querySelectorAll("input")
...
console.log(`the total number of image elements are ${document.querySelectorAll("img").length}`)
